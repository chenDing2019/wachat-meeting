...
@Component(value = MessageType.TEXT)
public class TextMessageConvertXml implements MessageConvertXml {
    ...
    public String messageConvertXml(Map<String, String> map) {
        ...
        //TODO 调用图灵机器人智能回复
        respContent = GetRespMsg.getTextMsg(ReqType.TEXT, content,null);
        // 回复文本消息 组装要返回的文本消息对象；
